 ...
 */
function wc_gateway_sirumobile_create_menupage() { ?>
    <?php add_thickbox(); ?>
    <div class="wrap">
 ...
 * Register Settings
 */
function wc_gateway_sirumobile_register_settings() {
...
add_action( 'admin_init', 'wc_gateway_sirumobile_register_settings' );
